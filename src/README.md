...
**Важная находка - циклический паттерн:**
- Наблюдается **рост архаизмов к концу каждого раннего периода**:
  - Пик в конце Классицизма (~1800s)
  - Пик в конце Сентиментализма (~1810s)  
  - Пик в конце Романтизма (~1830s)
  - Локальный рост в конце Реализма (~1890s)
- У модернистских течений (Символизм, Футуризм, Советская поэзия) 
  паттерн отсутствует - идёт устойчивое снижение
- **Интерпретация:** "Прощание с эпохой" через обращение к традиции.
  Архаизация как сознательный эстетический выбор, а не пассивный след
